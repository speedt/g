...
(() => {
  var sql = 'SELECT c.value_, b.user_name, a.* FROM w_exchange a, s_user b, s_cfg c WHERE a.user_id=b.id AND a.card_type_id=c.key_ AND c.type_="card_type" AND a.status=0 ORDER BY a.create_time DESC';
